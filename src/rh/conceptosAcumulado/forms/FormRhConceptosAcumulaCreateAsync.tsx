...
const FormRhConceptosAcumulaCreateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  //const [valueHasta, setValueHAsta] = useState<Dayjs | null>( dayjs(rhConceptoAcumuladoSeleccionado.fechaDesdeString));
  ...
  const handlerTipoAcumulado=async (e: any,value:any)=>{
    console.log('handlerTipoAcumulado',value)
    if(value!=null){
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/RhConceptoAcumulado/Create',updateConceptoAcumulado);
...
export default FormRhConceptosAcumulaCreateAsync
