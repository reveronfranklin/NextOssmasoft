...
const FormRhTipoNominaCreateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/RhTipoNomina/Create',update);
...
export default FormRhTipoNominaCreateAsync
