...
const FormRhExperienciaCreateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  return (
    <Card>
      <CardHeader title='RH - Crear Experiencia' />
      <CardContent>
...
export default FormRhExperienciaCreateAsync
