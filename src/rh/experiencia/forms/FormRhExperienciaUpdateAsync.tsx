...
const FormRhExperienciaUpdateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  return (
    <Card>
      <CardHeader title='RH - Modificar Experiencia' />
      <CardContent>
            ...
            <Grid item xs={12}>
              ...
              >
                <DialogTitle id="alert-dialog-title">
                  {"Esta Seguro de Eliminar estos Datos de Experiencia?"}
                </DialogTitle>
                <DialogContent>
                  <DialogContentText id="alert-dialog-description">
                    Se eliminaran los datos de Experiencia
                  </DialogContentText>
                </DialogContent>
                <DialogActions>
...
export default FormRhExperienciaUpdateAsync
