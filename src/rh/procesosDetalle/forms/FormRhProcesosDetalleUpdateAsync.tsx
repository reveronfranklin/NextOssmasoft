...
import { IRhProcesosDetalleDeleteDto } from 'src/interfaces/rh/ProcesosDetalle/RhProcesosDetalleDeleteDto'
...
const FormRhProcesosDetalleUpdateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  const handleDelete = async  () => {
    ...
    setOpen(false);
    const deleteConcepto : IRhProcesosDetalleDeleteDto={
      codigoDetalleProceso:rhProcesosDetalleSeleccionado.codigoDetalleProceso
    }
    const responseAll= await ossmmasofApi.post<any>('/RhProcesosDetalle/Delete',deleteConcepto);
    setErrorMessage(responseAll.data.message)
    if(responseAll.data.isValid){

      dispatch(setVerRhProcesosDetalleActive(false))
      dispatch(setRhProcesosDetalleSeleccionado({}))
    }
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/RhProcesosDetalle/Update',updateProcesoDetalle);
...
export default FormRhProcesosDetalleUpdateAsync
