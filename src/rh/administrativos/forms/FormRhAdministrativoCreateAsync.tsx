...
const FormRhAdministrativoCreateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
...
export default FormRhAdministrativoCreateAsync
