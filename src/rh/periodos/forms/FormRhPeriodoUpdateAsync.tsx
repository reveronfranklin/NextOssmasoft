...
import { IRhPeriodoDelete } from 'src/interfaces/rh/Periodos/RhPeriodoDelete'
...
const FormRhPeriodoUpdateAsync = ({
  popperPlacement
}: {
  ...
  const handleDelete = async () => {
    setOpen(false)
    const deletePeriodo: IRhPeriodoDelete = {
      codigoPeriodo: rhPeriodoSeleccionado.codigoPeriodo
    }
    const responseAll = await ossmmasofApi.post<any>('/RhPeriodosNomina/Delete', deletePeriodo)
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    const responseAll = await ossmmasofApi.post<any>('/RhPeriodosNomina/Update', update)
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={5}>
            ...
            <Grid item xs={12}>
              ...
              >
                <DialogTitle id='alert-dialog-title'>{'Esta Seguro de Eliminar este periodo?'}</DialogTitle>
                <DialogContent>
                  <DialogContentText id='alert-dialog-description'>
                    Se eliminaran los datos de periodo, solo si no esta cerrado
                  </DialogContentText>
                </DialogContent>
                <DialogActions>
...
export default FormRhPeriodoUpdateAsync
