...
import { IRhConceptosFormulaDeleteDto } from 'src/interfaces/rh/ConceptosFormula/RhConceptosFormulaDeleteDto'
...
const FormRhConceptosFormulaUpdateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  const handleDelete = async  () => {
    ...
    setOpen(false);
    const deleteConcepto : IRhConceptosFormulaDeleteDto={
      codigoFormulaConcepto:rhConceptoFormulaSeleccionado.codigoFormulaConcepto
    }
    const responseAll= await ossmmasofApi.post<any>('/RhConceptoFormula/Delete',deleteConcepto);
 ...
 const handleClearHasta=()=>{
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/RhConceptoFormula/Update',updateConceptoAcumulado);
  ...
  return (
    <Card>
      <CardHeader title='RH - Modificar Concepto Formula' />
      <CardContent>
...
export default FormRhConceptosFormulaUpdateAsync
