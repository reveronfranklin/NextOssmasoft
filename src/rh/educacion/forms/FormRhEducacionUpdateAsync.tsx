...
import { IRhEducacionDeleteDto } from 'src/interfaces/rh/RhEducacionDeleteDto'
...
const FormRhEducacionUpdateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  const defaultValues:IRhEducacionResponseDto = {
    ...
    codigoEducacion :rhEducacionSeleccionado.codigoEducacion,
  ...
  const handleClose = () => {
    ...
    dispatch(setRhEducacionSeleccionado({}))
  };
  ...
  const handleDelete = async  () => {
    ...
    setOpen(false);
    const deleteEducacion : IRhEducacionDeleteDto={
      codigoEducacion:rhEducacionSeleccionado.codigoEducacion
    }
    const responseAll= await ossmmasofApi.post<any>('/RhEducacion/Delete',deleteEducacion);
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/RhEducacion/Update',updateEducacion);
            ...
            <Grid item xs={12}>
              ...
              >
                <DialogTitle id="alert-dialog-title">
                  {"Esta Seguro de Eliminar estos Datos de Educacion?"}
                </DialogTitle>
                <DialogContent>
                  <DialogContentText id="alert-dialog-description">
                    Se eliminaran los datos de Educacion
                  </DialogContentText>
                </DialogContent>
                <DialogActions>
...
export default FormRhEducacionUpdateAsync
