...
const FormRhConceptosPUCCreateAsync = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] }) => {
  // ** States
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/RhConceptoPUC/Create',updateConceptoPUC);
  ...
  return (
    <Card>
      <CardHeader title='RH - Crear Concepto PUC' />
      <CardContent>
...
export default FormRhConceptosPUCCreateAsync
