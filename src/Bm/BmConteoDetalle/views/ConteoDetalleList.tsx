  ...
  return (
    <Grid item xs={12}>
       <Card>
        ...
        <DatePickerWrapper>
              <DialogBmConteoDetalleInfo  popperPlacement={popperPlacement} />
        </DatePickerWrapper>
    </Grid>
...
export default ConteoDetalleList
