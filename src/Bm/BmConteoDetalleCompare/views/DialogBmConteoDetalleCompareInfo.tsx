...
import FormBmConteoDetalleCompareUpdateAsync from '../forms/FormBmConteoDetalleCompareUpdateAsync'
...
const DialogBmConteoDetalleCompareInfo = ({ popperPlacement }: { popperPlacement: ReactDatePickerProps['popperPlacement'] })  => {
        ...
        >
          <DialogContent sx={{ pb: 8, px: { xs: 8, sm: 15 }, pt: { xs: 8, sm: 12.5 }, position: 'relative' }}>
            ...
            <DatePickerWrapper>
              ...
              ?  <FormBmConteoDetalleCompareUpdateAsync />
                :<FormBmConteoDetalleCompareUpdateAsync  />
              }
            </DatePickerWrapper>
...
export default DialogBmConteoDetalleCompareInfo
