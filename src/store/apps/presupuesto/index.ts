...
import { ICompromiso } from "../../../presupuesto/compromiso/interfaces/responseGetAll.interfaces"
...
export const presupuestoSlice = createSlice({
  ...
  initialState: {
    ...
    isLoading:false,
    setVerComrpromisoActive:false,
    compromisoSeleccionado:{} as ICompromiso,
  },
  reducers: {
    setVerComrpromisoActive:(state,action)=>{
      state.setVerComrpromisoActive=action.payload
    },
    setCompromisoSeleccionado:(state,action)=>{
      state.compromisoSeleccionado=action.payload
    },
