...
import { setPreDetalleDocumentoCausado, setVerPreDetalleDocumentoCausadoActive } from 'src/store/apps/presupuesto';
...
import TableBasicCausado from './TableBasicCausado'
...
const DialogPreVSaldoDocumentosCausadoInfo = () => {

  // ** States
  const dispatch = useDispatch();
  const {verPreDetalleDocumentoCausadoActive,preVSaldoSeleccionado} = useSelector((state: RootState) => state.presupuesto)
  ...
  const fetchTableData = useCallback(
    async (codigoPresupuesto:number,codigoSaldo:number) => {
      ...
      dispatch(setPreDetalleDocumentoCausado(responseAll.data.data));
  ...
  return (
    <Card>
      ...
      <Dialog
        fullWidth
        open={verPreDetalleDocumentoCausadoActive}
        maxWidth='lg'
        scroll='body'
...
export default DialogPreVSaldoDocumentosCausadoInfo
