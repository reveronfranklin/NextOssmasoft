...
import {  setPreDetalleDocumentoPagado, setVerPreDetalleDocumentoPagadoActive } from 'src/store/apps/presupuesto';
...
import TableBasicPagado from './TableBasicPagado'
...
const DialogPreVSaldoDocumentosPagadoInfo = () => {
  ...
  const {verPreDetalleDocumentoPagadoActive,preVSaldoSeleccionado} = useSelector((state: RootState) => state.presupuesto)
  ...
  return (
    <Card>
      ...
      <Dialog
        fullWidth
        open={verPreDetalleDocumentoPagadoActive}
        maxWidth='lg'
        scroll='body'
