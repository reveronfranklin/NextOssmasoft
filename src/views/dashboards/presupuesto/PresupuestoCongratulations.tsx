...
const PresupuestoCongratulations = () => {
  return (
      ...
      <CardContent sx={{ p: theme => `${theme.spacing(8.25, 7.5, 6.25, 7.5)} !important` }}>
        <Grid container spacing={6}>
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant='body2'>You have done 72% 🤩 more sales today. Presupuesto Chacao</Typography>
            <Typography variant='body2'>Check your new raising badge in your profile.</Typography>
          </Grid>
          <StyledGrid item xs={12} sm={6}>
            <Img alt='' src='/images/cards/illustration-john-2.png' />
          </StyledGrid>
        </Grid>
      </CardContent>
    </Card>
...
export default PresupuestoCongratulations
