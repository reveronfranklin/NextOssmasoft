...
const PresupuestoList = () => {
  ...
  const getReport = async () => {
    ...
    const filter: IReportRequestDto = {
      ...
      reportUrl:
        'http://192.168.1.124:7779/reports/rwservlet?destype=cache&desformat=pdf&server=samiAIO_webpre&report=PRE_PUC2.rdf&userid=system/s4m1apps@samiapps'
    }
