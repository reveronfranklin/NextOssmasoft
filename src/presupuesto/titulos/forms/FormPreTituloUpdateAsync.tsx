...
import { IPreTituloDeleteDto } from 'src/interfaces/Presupuesto/i-pre-titulos-delete-dto'
...
const FormPreTituloUpdateAsync = () => {
  // ** States
  ...
  const handleDelete = async  () => {
    ...
    setOpen(false);
    const deleteTitulo : IPreTituloDeleteDto={
      tituloId:preTituloSeleccionado.tituloId
    }
    const responseAll= await ossmmasofApi.post<any>('/PreTitulos/Delete',deleteTitulo);
    setErrorMessage(responseAll.data.message)
    if(responseAll.data.isValid){

      dispatch(setVerPreTituloActive(false))
      dispatch(setPreTituloSeleccionado({}))
    }
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/PreTitulos/Update',updateTitulo);
            ...
            <Grid item xs={12}>
              ...
              >
                <DialogTitle id="alert-dialog-title">
                  {"Esta Seguro de Eliminar este TITULO?"}
                </DialogTitle>
                <DialogContent>
                  <DialogContentText id="alert-dialog-description">
                    Se eliminara el TITULO solo si no tiene movimiento asociado
                  </DialogContentText>
                </DialogContent>
                <DialogActions>
...
export default FormPreTituloUpdateAsync
