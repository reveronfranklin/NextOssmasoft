...
const FormPucCreateAsync = () => {
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/PrePlanUnicoCuentas/Create',updatePuc);
  ...
  return (
    <Card>
      <CardHeader title='Crear Plan Unico Cuenta (PUC)' />
      <CardContent>
...
export default FormPucCreateAsync
