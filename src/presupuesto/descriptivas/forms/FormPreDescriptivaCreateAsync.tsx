...
const FormPreDescriptivaCreateAsync = () => {
  // ** States
  ...
  const onSubmit = async (data:FormInputs) => {
    ...
    const responseAll= await ossmmasofApi.post<any>('/PreDescriptivas/Create',updateDescriptiva);
...
export default FormPreDescriptivaCreateAsync
