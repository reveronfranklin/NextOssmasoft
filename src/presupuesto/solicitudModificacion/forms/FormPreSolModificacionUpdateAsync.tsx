...
import { IPreSolModificacionDeleteDto } from 'src/interfaces/Presupuesto/PreSolicitudModificacion/PreSolModificacionDeleteDto'
...
const FormPreSolModificacionUpdateAsync = ({
  ...
  const handleDelete = async () => {
    ...
    const responseAll = await ossmmasofApi.post<any>('/PreSolModificacion/Delete', deleteSol)
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    const update: IPreSolModificacionUpdateDto = {
      codigoSolModificacion: data.codigoSolModificacion,
    ...
    const responseAll = await ossmmasofApi.post<any>('/PreSolModificacion/Update', update)
...
export default FormPreSolModificacionUpdateAsync
