...
const DialogPrePucSolModificacionInfo = ({ dePara }: Props) => {
  // ** States
  const dispatch = useDispatch()
  const { verPrePucSolModificacionActive, operacionCrudPrePucSolModificacion } = useSelector(
  ...
  const handleSetShow = (active: boolean) => {
    ...
    dispatch(setVerPrePucSolModificacionActive(active))
  }
...
export default DialogPrePucSolModificacionInfo
